  ...
  <el-dialog :title="dialogProps.title" :visible.sync="dialogProps.visible" width="560px"
    ...
    <el-form :model="resourceModel" :rules="formRules"
      ...
      <el-form-item label="资源名称" prop="name">
        <el-col :span="16"><el-input ref="name" :maxlength="32" v-model="resourceModel.permissionName"></el-input></el-col>
      </el-form-item>
      <el-form-item label="权限代码" prop="permissionCode">
        <el-col :span="16"><el-input :maxlength="32" v-model="resourceModel.permissionCode"></el-input></el-col>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    doUpdateResource () {
      this.loading = true
      updateResource(this.resourceModel)
        .then(response => {
          this.loading = false
